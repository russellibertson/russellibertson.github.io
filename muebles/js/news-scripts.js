$(document).ready(function(){ 
   ...
   $('.filter__panel').click(function(){
      ...
      if($('.content__items').hasClass('content__items-active'))
      {
         setTimeout(()=>{
            $('.content__items').removeClass('content__items-active');
            
         },410)
      }else{
         $('.content__items').addClass('content__items-active');
      }
      // $('.content__items').toggleClass('content__items-active');
